...
<body>
	...
	<header>
		<nav>
			...
			<c:set var="currentPage" value="yourBooking" />
			<ul class="nav-links">
				<li><a href="home" >Home</a></li>
				<li><a href="caravan">Caravans</a></li>

				<li><a href="yourBooking" class="${currentPage eq 'yourBooking' ? 'current' : ''}"> Your Bookings</a></li>
	...
	<table border="1">
		...
		<tbody>
			<c:forEach var="booking" items="${allBookings}">
				<c:if
					test="${fn:contains(booking.bookingUserDetails, sessionScope.loginuser.userName) and fn:contains(booking.bookingUserDetails, sessionScope.loginuser.email)}">
					<tr>
