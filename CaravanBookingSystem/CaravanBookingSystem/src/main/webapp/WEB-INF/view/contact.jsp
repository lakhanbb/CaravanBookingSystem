...
.hero {
	background-image: url(https://github.com/lakhanbb/caravan-img/raw/main/caravan-img.jpg);
		...
		<nav>
			...
			<ul class="nav-links">
				...
				<c:choose>
					...
					<li><a href="contact" class="${currentPage eq 'contact' ? 'current' : ''}">Contact</a></li>
