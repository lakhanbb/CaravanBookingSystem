...
<body>
	...
	<header>
		<nav>
			...
			<ul class="nav-links">
				<li><a href="home"
					class="${currentPage eq 'home' ? 'current' : ''}">Home</a></li>
	...
	<section class="hero">
		<h2>Welcome to Vacation on Wheel</h2>
		<p>Your Perfect Caravan Adventure Awaits</p>
		<a href="caravan" class="btn">Explore Caravans</a>
	</section>
