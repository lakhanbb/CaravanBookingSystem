...
<body>
	...
	<header>
		<nav>
			...
			<c:set var="currentPage" value="adminBooking" />
			<ul class="nav-links">
				...
				<c:if
					...
					<li><a href="adminBooking" class="${currentPage eq 'adminBooking' ? 'current' : ''}">All Bookings</a></li>
				</c:if>
...
<h2 style="text-align: left;;margin-top:20px;">All Bookings</h2>
	<table border="1">
		<thead>
			<tr>
				<th>Caravan ID</th>
